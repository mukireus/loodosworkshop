  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ...
    if (firebaseUser.getEmail().equalsIgnoreCase(message.getGonderici())){
      ...
      convertView = LayoutInflater
          .from(getContext()).inflate(R.layout.chat_bubble_right, parent, false);
      ...
      convertView = LayoutInflater.from(getContext()).inflate(R.layout.chat_bubble_left, parent, false);
